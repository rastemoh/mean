...
describe('Article CRUD tests', function () {
  ...
  it('should be able to get a list of module_name if not signed in', function (done) {
    ...
    articleObj.save(function () {
      // Request module_name
      request(app).get('/api/module_name')
  ...
  it('should be able to get a single article if not signed in', function (done) {
    ...
    // Save the article
    articleObj.save(function () {
      request(app).get('/api/module_name/' + articleObj._id)
        .end(function (req, res) {
          // Set assertion
  ...
  it('should return proper error for single article with an invalid Id, if not signed in', function (done) {
    ...
    request(app).get('/api/module_name/test')
      .end(function (req, res) {
        // Set assertion
  ...
  it('should return proper error for single article which doesnt exist, if not signed in', function (done) {
    ...
    request(app).get('/api/module_name/559e9cd815f80b4c256a8f41')
      .end(function (req, res) {
        // Set assertion
  ...
  it('should not be able to delete an article if not signed in', function (done) {
    ...
    articleObj.save(function () {
      ...
      request(app).delete('/api/module_name/' + articleObj._id)
        .expect(403)
        ...
        .end(function (signinErr, signinRes) {
          ...
          agent.post('/api/module_name')
            ...
            .end(function (module_nameaveErr, module_nameaveRes) {
              ...
              (module_nameaveRes.body.title).should.equal(article.title);
              should.exist(module_nameaveRes.body.user);
              should.equal(module_nameaveRes.body.user._id, orphanId);
        ...
        .end(function (signinErr, signinRes) {
          ...
          agent.post('/api/module_name')
            ...
            .end(function (module_nameaveErr, module_nameaveRes) {
              ...
              (module_nameaveRes.body.title).should.equal(article.title);
              should.exist(module_nameaveRes.body.user);
              should.equal(module_nameaveRes.body.user._id, userId);
