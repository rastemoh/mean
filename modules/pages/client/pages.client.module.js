(function (app) {
  ...
  app.registerModule('pages.custom', ['pages', 'slider.services', 'agPerson.services']);// The core module is required for special route handling; see /core/client/config/core.client.routes
