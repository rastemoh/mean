(function () {
  ...
  angular
    ...
    .controller('AgPersonAdminController', AgPersonAdminController);

  AgPersonAdminController.$inject = ['$scope', '$state', '$window', 'agPersonResolve', 'Authentication', 'Notification', '$uibModal'];

  function AgPersonAdminController($scope, $state, $window, item, Authentication, Notification, $uibModal) {
    var vm = this;
    ...
    function save(isValid) {
      ...
      function successCallback(res) {
        $state.go('admin.agPerson.list'); // should we send the User to the list or the updated Item's view?
